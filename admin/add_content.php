...
if(isset($_POST['submit'])){
   ...
   $video_size = $_FILES['video']['size']; // Get video file size
   ...
   } elseif ($video_size > 524288000) { // 500MB in bytes
      $message[] = 'Video size is too large! Please select a video under 500MB.';
   } else {
      // Insert video and thumbnail into database and move files
